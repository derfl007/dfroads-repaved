...
class BollardBlock(settings: Settings) : HorizontalFacingBlock(settings) {
    ...
    override fun getOutlineShape(
        ...
        return VoxelShapes.createHorizontalFacingShapeMap(
            createCuboidShape(6.5, 0.0, 7.0, 9.5, 16.0, 9.0),
        )[state[FACING]]
    }

    override fun getCodec(): MapCodec<out HorizontalFacingBlock?>? = createCodec(::BollardBlock)
}